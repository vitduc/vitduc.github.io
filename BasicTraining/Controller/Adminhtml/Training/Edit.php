...
class Edit extends \Cowell\BasicTraining\Controller\Adminhtml\Student implements HttpGetActionInterface
{
    /**
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? 'Edit: ' . $model->getName() : __('New student'));
        return $resultPage;
    }
}
